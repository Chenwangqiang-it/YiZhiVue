            ...
            <el-table
                ...
                <template slot-scope="props">
                    <el-form label-position="left"  class="demo-table-expand">
                      <el-form-item label="流程状态">
                        ...
                        <span v-if="props.row.schedules==7">盖章材料审核</span>
                        <span v-if="props.row.schedules==8">待商务局审查</span>
                      ...
                      <el-form-item label="报件人姓名">
                        <span>{{ props.row.uname }}</span>
                      </el-form-item>
                      <el-form-item label="代理人" v-if="props.row.schedules>2">
                      ...
                      <el-form-item label="附件下载" v-if="props.row.inventory!=''&&props.row.inventory!=null">
                      ...
                      <el-form-item label="申报材料下载" v-if="props.row.declaration!=''&&props.row.declaration!=null">
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                    <el-link @click="info(scope.row.cid)">{{scope.row.serialNum}}</el-link>
                </template>
              </el-table-column>
              <el-table-column
                width="200" 
                ...
                label="客户名称">
                <template slot-scope="scope">
                    <el-link @click="info(scope.row.cid)">{{scope.row.companyName}}</el-link>
                </template>
              </el-table-column>
              <el-table-column
                width="100" 
                ...
                label="品牌名称">
                <template slot-scope="scope">
                    <el-link @click="info(scope.row.cid)">{{scope.row.brandName}}</el-link>
                </template>
              </el-table-column>
              <el-table-column
                width="70" 
              ...
              <el-table-column width="110" align="center" prop="schedule" label="流程状态" >
                <template slot-scope="scope">
                    ...
                    <span v-if="scope.row.schedules==7" style="color:#00a74a">盖章材料审核</span>
                    <span v-if="scope.row.schedules==8" style="color:#17a05d">待商务局审查</span>
              ...
              <el-table-column width="200" align="center" prop="gmtModified" label="修改时间" ></el-table-column>
              <el-table-column width="80" align="center" prop="schedule" label="处理人" >
                <template slot-scope="scope">
                    <span v-if="scope.row.schedules==1" >财务</span>
                    <span v-if="scope.row.schedules==2" >流程</span>
                    ...
                    <span v-if="scope.row.schedules==9" >流程</span>
                    <span v-if="scope.row.schedules==10" >{{scope.row.uname}}</span>
                    <span v-if="scope.row.schedules==11" >财务</span>
